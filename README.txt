...
To correctly access foodtruck finder, one must type in the url for the server followed by a query string containing three floats: lat, lon, and radius (ex: https://nameless-bastion-3232.herokuapp.com/?lat=37.79&lon=-122.4&radius=300). 
